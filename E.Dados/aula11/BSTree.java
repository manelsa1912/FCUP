public class BSTree<T extends Comparable<? super T>> {   
   ...
   public int countBetween(T a, T b){
      return countBetween(a,b,root);
   }
   
   private int countBetween(T a, T b, BSTNode<T> n){
    
      if(n == null) return 0;
      if(n.getValue().compareTo(a) < 0) return countBetween(a,b,n.getRight());
      if(n.getValue().compareTo(b) > 0) return countBetween(a,b,n.getLeft());
      if(n.getValue().compareTo(a) >= 0 && n.getValue().compareTo(b) <= 0)
      return  1+countBetween(a,b,n.getLeft()) + countBetween(a,b,n.getRight());
      
      return countBetween(a,b,n.getLeft()) + countBetween(a,b,n.getRight());
