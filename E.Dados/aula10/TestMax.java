public class TestMax {
   ...
   public static void main(String[] args) {
      ...
      System.out.println("sumRec2:" + sumRec1(v, 0, v.length-1));  
   }
 ...
 if (start == end) return v[start];
      int middle = (start + end) / 2;       // ponto medio
      int max1 = sumRec2(v, start, middle); // recursao na metade esquerda
      int max2 = sumRec2(v, middle+1, end); // recursao na metade direita
      return max1 + max2;          // combinar resultado
  }
